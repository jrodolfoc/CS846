...
//	 * @throws IOException
//	 */
//	public List<User> getUsers(Map<String, String> filterData) throws IOException {
...
//	}
	 ...
	 *
	 * @param filterData
	 * @return iterator over pages of users
	 */
	public PageIterator<User> pageUsers(Map<String, String> filterData) {
		return pageUsers(filterData, 0, PAGE_SIZE);
	}
	 ...
	 */
	public PageIterator<User> pageUsers(Map<String, String> filterData, int start, int size)
	{
		PagedRequest<User> request = createPagedRequest(start, size);
